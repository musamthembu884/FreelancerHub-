	...
	<div class="row">
		<div class="col-md-12 profile-area">
			<div class="media col-md-6 col-sm-6 col-xs-6">
				...
				<button class="btn btn-primary btn-raised ">Sankofa Future</button>
					<br>
					<a href="#"><button class="btn btn-info btn-raised btn-xs">Music Producer</button></a>
			...
			<div class="col-md-6 col-sm-6 col-xs-6">
				...
				<button class="btn btn-primary  btn-fab"><i class="fa fa-facebook"></i></button>
					<button class="btn btn-primary  btn-fab"><i class="fa fa-linkedin"></i></button>
					<button class="btn btn-primary  btn-fab"><i class="fa fa-twitter"></i></button>
					<button class="btn btn-primary  btn-fab"><i class="fa fa-instagram"></i></button>
					
				</ul>
				<div>
					<ul class="demo-btns text-right">
                       <button class="btn btn-primary btn-raised"><i class="fa fa-thumbs-up"></i>554 Followers</button>
		...
		<div class="col-md-12 pl-n pr-n">
			<ul class="nav nav-tabs material-nav-tabs mb-lg">
				<li><a href="#tab-8-1" data-toggle="tab"> About </a></li>
				<li class="active"><a href="#tab-8-2" data-toggle="tab"> Timeline</a></li>
				<li style="display:none"><a href="#tab-8-3" data-toggle="tab"> Projects</a></li>
				<li style="display:none"><a href="#tab-8-4" data-toggle="tab"> Photos</a></li>
				<li style="display:none"><a href="#tab-8-5" data-toggle="tab"> Edit</a></li>
			</ul>
		</div>
		<div class="col-md-3">
			  	...
			  	<div class="panel-body">
					<div>
						...
						<div class="personel-info">
							<button class="btn btn-info btn-raised btn-xs"><i class="fa fa-phone"></i></button>
							<span><strong>(+27)79 456 7896</strong></span>
						</div>
					...
					<button class="btn btn-info btn-raised btn-xs"><i class="fa fa-facebook"></i></button>
					<button class="btn btn-info btn-raised btn-xs"><i class="fa fa-twitter"></i></button>
					<button class="btn btn-info btn-raised btn-xs"><i class="fa fa-linkedin"></i></button>
					<button class="btn btn-info btn-raised btn-xs"><i class="fa fa-instagram"></i></button>
...
<script src="assets/js/chat.js"></script> 									<!-- Load Enquire -->
