...
<li><a href="#">Apps</a></li>
<li class="active"><a href="form-summernote.html">Note Keeper</a></li>
...
<div data-widget-group="group1">
	...
	<div class="col-md-4">
					...
					<h2 style="color:white; text-align:center">My Notes</h2>
				</div>
	    ...
	    <div class="col-xs-8">
	    	<div class="panel panel-default" data-widget='{"draggable": "false"}'>
		        <div style="background-color:#00bcd4" class="panel-heading">
					<h2 style="color:white; text-align:center">Untitled Note</h2>
